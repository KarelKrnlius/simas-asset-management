            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <div class="relative min-w-[160px] flex-1">
                        <input type="text"
                               id="searchInput"
                               placeholder="Cari kode peminjaman, nama, email..."
                    ...
                    <div class="relative">
                        <select id="sortSelect"
                                ...
                                class="px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm font-semibold text-slate-700 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-red-primary focus:border-transparent cursor-pointer">
...
function confirmBulkDelete(event) {
    ...
    if (loanIds.length === 0) {
        alert('Tidak ada peminjaman yang dipilih');
        return;
    }
    ...
    // Send delete request
    fetch('/pengecek-peminjaman/bulk-delete', {
        method: 'POST',
        headers: {
    ...
    .then(data => {
        if (data.success) {
            ...
            alert('Gagal menghapus peminjaman: ' + data.message);
        }
    })
    .catch(error => {
        console.error('Error:', error);
    ...
    <div class="bg-white rounded-2xl shadow-2xl p-6 max-w-md w-full mx-4">
        ...
        <div class="bg-red-50 border border-red-200 rounded-xl p-4 mb-6">
            <p class="text-sm text-red-800">
                <i class="fas fa-info-circle mr-2"></i>
                Anda akan menghapus <strong id="selectedCount">0</strong> peminjaman. Asset yang dipinjam akan dikembalikan ke status tersedia.
            </p>
        </div>
