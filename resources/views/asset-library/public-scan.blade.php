...
<body class="bg-slate-100 min-h-screen flex items-center justify-center p-4">
    ...
    <!-- CARD -->
    <div class="bg-red-700 p-8 rounded-3xl shadow-2xl text-center w-full max-w-[420px] relative">
        ...
        <!-- SCANNER -->
        <div class="relative w-[340px] h-[340px] mx-auto mb-6 rounded-2xl overflow-hidden bg-black">
            ...
            <button onclick="toggleFlash()"
                class="absolute top-3 right-3 text-white text-xl opacity-70 hover:opacity-100 transition z-10">
                ⚡
            </button>
        ...
        <!-- UPLOAD -->
        <label class="bg-white text-red-600 px-6 py-2 rounded-xl text-sm font-semibold cursor-pointer hover:opacity-90 inline-block">
            Upload QR
    ...
    function onScanSuccess(decodedText) {
        ...
        console.log("Redirecting to asset detail:", `/asset/${code}`);

        // Redirect directly to public asset detail page
        window.location.href = `/asset/${encodeURIComponent(code)}`;
    }
    ...
    function startScanner() {
        ...
        html5QrCode.start(
            ...
            console.error(err);
            alert("Kamera tidak bisa diakses. Pastikan izinkan akses kamera.");
        });
    }
    ...
    function scanFileInternal(file, readerDiv, originalContent) {
        ...
        .then(decodedText => {
            ...
            console.log("Final code extracted:", code);
            console.log("Redirecting to:", `/asset/${encodeURIComponent(code)}`);
